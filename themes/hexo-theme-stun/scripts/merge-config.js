  ...
  if (hexo.locals.get) {
    ...
    if (targetLangData) {
      ...
      if (Object.keys(flattenData).length) {
        // Merge into the theme's own i18n instead of replacing it.
        // Replacing would drop every key not redeclared in source/_data/languages/*.yml.
        hexo.theme.i18n.data[usingLang] = Object.assign(
          {},
          hexo.theme.i18n.data[usingLang] || {},
          flattenData
        )
      }
    }
